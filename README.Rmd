...
Now we shuffle the set of `input_polygons` to random locations within our bounding box area. We repeat this random shuffle 100 times, and save the locations of the polygons for each random shuffle event:
